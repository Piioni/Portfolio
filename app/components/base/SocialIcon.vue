...
const iconName = computed(() => getSocialIcon(props.platform))
</script>

<template>
  <a
    :href="props.href"
    :target="props.platform !== 'email' ? '_blank' : undefined"
    :rel="props.platform !== 'email' ? 'noopener noreferrer' : undefined"
  ...
  >
    <Icon :name="iconName" class="size-5" aria-hidden="true" />
  </a>
</template>
